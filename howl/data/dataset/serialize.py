...
=======
    ...
    def load_train_set(self, path: Path, **dataset_kwargs) -> Tuple[AudioClipDataset, AudioClipDataset, AudioClipDataset]:
        self.path = path
    ...
    def load_dev_set(self, path: Path, **dataset_kwargs) -> Tuple[AudioClipDataset, AudioClipDataset, AudioClipDataset]:
        self.path = path
        ...
        return load('dev.json', DatasetType.DEV)

    def load_test_set(self, path: Path, **dataset_kwargs) -> Tuple[AudioClipDataset, AudioClipDataset, AudioClipDataset]:
        self.path = path
        ...
        return load('test.json', DatasetType.TEST)
>>>>>>> 15fcc6292a34e77f3f7c9bf68f6897cde6fbbd10
