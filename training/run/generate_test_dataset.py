...
def do_record_sequence():
    ...
    parser.add_argument(
        "--min-sound-lvl", type=float, default=0.01, help="Minimum sound level at which audio is not considered silent"
    )
    parser.add_argument(
        "--timeout-seconds", type=float, default=1.0, help="Duration of silence after which recording halts"
    )
