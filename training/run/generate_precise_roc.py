...
def get_metrics(exp_type, workbook, thresholds):
    """Reorganize entries in the Excel file into dev_far, dev_frr, test_far, test_frr
    ...
    Returns:
        dev_far, dev_frr, test_far, test_frr
    """
    dev_far = []
    dev_frr = []
...
def main():
    """
    This script takes in both reports for precise dataset and reports
    for howl generated by run_exp.py to create roc curve
    ...
    apb.add_options(
        ArgOption("--howl_exp_timestemp", type=str, default="Sep-08-11-28"),
        ArgOption("--precise_exp_timestemp", type=str, default="Sep-08-11-28"),
        ArgOption("--howl_exp_dir", type=str, default="exp_results/"),
        ArgOption("--precise_exp_dir", type=str, default="../mycroft-precise/exp_results/"),
        ArgOption("--exp_type", type=str, default="hey_ff"),
    )
    ...
    precise_clean_dev_far, precise_clean_dev_frr, precise_clean_test_far, precise_clean_test_frr = get_metrics(
        args.exp_type, precise_clean_wb, thresholds
    )
    precise_noisy_dev_far, precise_noisy_dev_frr, precise_noisy_test_far, precise_noisy_test_frr = get_metrics(
        args.exp_type, precise_noisy_wb, thresholds
    )
    ...
    plt.plot(
        precise_noisy_test_far[1:-1], precise_noisy_test_frr[1:-1], "-+", color="tab:purple", label="precise noisy"
    )
