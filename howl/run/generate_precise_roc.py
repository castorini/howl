...
"""
This script uses reports for precise dataset generated by run_exp.py to create roc curve

sample command:
python -m howl.run.generate_precise_roc --exp_timestamp Sep-08-11-28 --exp_type hey_firefox
"""
